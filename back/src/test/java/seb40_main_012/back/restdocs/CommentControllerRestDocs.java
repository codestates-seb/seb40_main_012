...
public class CommentControllerRestDocs {
    ...
    void postBookCommentTest() throws Exception {
        ...
        ResultActions actions =
                mockMvc.perform(
                        RestDocumentationRequestBuilders.post("/api/books/{isbn13}/comments/add", isbn13)
                ...
                .andDo(document(
                        ...
                        responseFields(
                                List.of(
                                        ...
                                        fieldWithPath("data.isLiked").type(JsonFieldType.BOOLEAN).description("코멘트 좋아요 여부"),
    ...
    void postPairingCommentTest() throws Exception {
        ...
        given(commentMapper.commentToCommentResponse(Mockito.any(Comment.class))).willReturn(response);
        doNothing().when(notificationService).notifyPostPairingCommentEvent(Mockito.any(Comment.class));
                ...
                .andDo(document(
                        ...
                        responseFields(
                                List.of(
                                        ...
                                        fieldWithPath("data.userInformation.bookTemp").type(JsonFieldType.NUMBER).description("책의 온기"),
                                        fieldWithPath("data.commentType").type(JsonFieldType.STRING).description("코멘트 타입"),
                                        fieldWithPath("data.bookTitle").type(JsonFieldType.NULL).description("책 제목"),
                                        fieldWithPath("data.pairingId").type(JsonFieldType.NUMBER).description("페어링 번호"),
    ...
    void getCommentTest() throws Exception {
        ...
        actions
                ...
                .andExpect(jsonPath("$.data.userInformation.bookTemp").value(response.getUserInformation().getBookTemp()))
                ...
                .andExpect(jsonPath("$.data.isLiked").value(response.getIsLiked()))
                .andDo(document(
                        "Get_Comment",
                        getDocumentRequest(),
                        getDocumentResponse(),
                ...
                .andDo(document("Get_Comments",
                        ...
                        responseFields(
                                List.of(
                                        ...
                                        fieldWithPath("data.content[].bookTitle").type(JsonFieldType.STRING).description("책 제목"),
                                        ...
                                        fieldWithPath("data.content[].isLiked").type(JsonFieldType.BOOLEAN).description("코멘트 좋아요 여부"),
