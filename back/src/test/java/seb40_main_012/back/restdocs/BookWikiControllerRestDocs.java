...
public class BookWikiControllerRestDocs {
    ...
    void postBookWikiTest() throws Exception {
        ...
        given(bookWikiService.createBookWiki(Mockito.any(BookWiki.class))).willReturn(new BookWiki());
        given(bookWikiMapper.bookWikiToBookWikiResponse(Mockito.any(BookWiki.class))).willReturn(response);

        ResultActions actions =
                mockMvc.perform(
                        RestDocumentationRequestBuilders.post("/api/books/{bookId}/wikis/add", bookId)
